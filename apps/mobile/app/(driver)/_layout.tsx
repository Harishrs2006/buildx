...
export default function DriverLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: styles.tabBar, tabBarShowLabel: false }}>
      <Tabs.Screen name="available" options={{ tabBarIcon: ({ focused }) => <TabIcon label="Available" emoji="📍" focused={focused} /> }} />
      <Tabs.Screen name="deliveries" options={{ tabBarIcon: ({ focused }) => <TabIcon label="My Deliveries" emoji="🚚" focused={focused} /> }} />
